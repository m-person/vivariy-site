# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-04-27 08:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text_ru', ckeditor_uploader.fields.RichTextUploadingField(default='', help_text='Full article text (in russian)', null=True, verbose_name='Article text (ru)')),
                ...
                ('source_url', models.URLField(blank=True, help_text='Source url', max_length=1024, null=True, verbose_name='Link to source')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('height', models.PositiveIntegerField(blank=True, null=True, verbose_name='Image height')),
                ('ppoi', versatileimagefield.fields.PPOIField(default='0.5x0.5', editable=False, help_text='Select center point for cropped (resized) image', max_length=20, verbose_name='Image point of interest')),
                ('order_position', models.SmallIntegerField(default=0, help_text='Serial number in list of slides', verbose_name='Ordering position')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='Company`s name (in russian)', max_length=512, verbose_name='Name (ru)')),
                ('title_en', models.CharField(help_text='Company`s name (in english)', max_length=512, verbose_name='Name (en)')),
                ('desc', models.TextField(blank=True, help_text='Company description in russian (4096 symbols max)', max_length=4096, null=True, verbose_name='Description (ru)')),
                ('desc_en', models.TextField(blank=True, help_text='Company description in english (4096 symbols max)', max_length=4096, null=True, verbose_name='Description (en)')),
                ('is_hidden', models.BooleanField(default=False, verbose_name='Don`t show this entry on site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc_full_ru', ckeditor_uploader.fields.RichTextUploadingField(blank=True, default='', help_text='Full device description in russian (10240 symbols max)', max_length=10240, null=True, verbose_name='Full description (ru)')),
                ('specifications_ru', ckeditor_uploader.fields.RichTextUploadingField(blank=True, default='', help_text='Technical characteristics in russian (10240 symbols max)', max_length=10240, null=True, verbose_name='Specifications (ru)')),
                ('options_ru', ckeditor_uploader.fields.RichTextUploadingField(blank=True, default='', help_text='Delivery options in russian (4096 symbols max)', max_length=4096, null=True, verbose_name='Options (ru)')),
                ('mentions_ru', ckeditor_uploader.fields.RichTextUploadingField(blank=True, default='', help_text='Links to researches using this device in russian (4096 symbols max)', max_length=4096, null=True, verbose_name='Mentions (ru)')),
                ('faq_ru', ckeditor_uploader.fields.RichTextUploadingField(blank=True, default='', help_text='Frequently asked questions (4096 symbols max)', max_length=4096, null=True, verbose_name='FAQ (ru)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_is_sent', models.BooleanField(default=False, help_text='Thist request was sent without errors', verbose_name='Was sent')),
            ],
        ),
        migrations.CreateModel(
            name='YoutubeVideo',
